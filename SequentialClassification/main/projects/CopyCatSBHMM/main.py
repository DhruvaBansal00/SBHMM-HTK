...
"""Main file used to prepare training data, train, and test HMMs.
    ...
    SBHMM Standard = python3 main.py --test_type standard --train_iters 25 50 75 100 120 140 160 --sbhmm_iters 25 50 75 100 --users 02-22-20_Prerna_Android 07-24-20_Matthew_4K --train_sbhmm --sbhmm_cycles 1 --no_pca --include_word_level_states --include_word_position --parallel_classifier_training --hmm_insertion_penalty -80 --sbhmm_insertion_penalty -80 --neighbors 70 --beam_threshold 3000.0
    SBHMM CV Parallel = python3 main.py --test_type cross_val --train_iters 25 50 75 100 120 140 160 --sbhmm_iters 25 50 75 100 --users 02-22-20_Prerna_Android 07-24-20_Matthew_4K --train_sbhmm --sbhmm_cycles 1 --no_pca --include_word_level_states --include_word_position --parallel_classifier_training --hmm_insertion_penalty -80 --sbhmm_insertion_penalty -80 --neighbors 70 --cross_val_method stratified --n_splits 10 --beam_threshold 3000.0 --cv_parallel --parallel_jobs 10
    Old SBHMM Standard = python3 main.py --test_type standard --train_iters 25 50 75 100 120 140 160 --sbhmm_iters 25 50 75 100 --users 02-22-20_Prerna_Android 07-24-20_Matthew_4K --train_sbhmm --sbhmm_cycles 1 --no_pca --include_word_level_states --parallel_classifier_training --hmm_insertion_penalty -80 --sbhmm_insertion_penalty -80 --beam_threshold 3000.0 --multiple_classifiers
"""
import sys
import glob
import argparse
