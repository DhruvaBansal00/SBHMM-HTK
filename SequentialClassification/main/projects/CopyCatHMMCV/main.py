"""Main file used to prepare training data, train, and test HMMs.
    HMM EX = python3 main.py --test_type standard --train_iters 25 50 75 --users Prerna Linda | python3 main.py --test_type cross_val --train_iters 25 50 75 --users Prerna Linda --cross_val_method stratified --n_splits 10 --hmm_insertion_penalty -80 --cv_parallel
