"""Main file used to prepare training data, train, and test HMMs.
    ...
    python3 main.py --test_type cross_val --train_iters 25 50 75 100 --users Prerna Linda --cross_val_method stratified --n_splits 10 --cv_parallel --parallel_jobs 4  --hmm_insertion_penalty -80
