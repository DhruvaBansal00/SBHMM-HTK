...
for subset in subsets:
	...
	os.system(f'python3 driver.py --prepare_data --save_results --test_type cross_val --users Matthew Linda David --train_iters 25 50 75 100 120 140 160 --hmm_insertion_penalty -80 --cross_val_method stratified --n_splits 5 --cv_parallel --parallel_jobs 10')